...
const translations = {
  en: {
    ...
    "search.lyricsFilter": "Show albums with lyrics",
    "view.label": "Album view",
    "view.largeIcons": "Large icons",
    "view.smallIcons": "Small icons",
    "view.list": "Album list",
    "listMode.albums": "Albums",
    "listMode.tracks": "Tracks",
    "listMode.albumTable": "Album table",
    "listMode.trackTable": "Track table",
    "listMode.trackCount": "Tracks",
    ...
    "tags.year": "Year",
    "tags.genre": "Genre",
    "tags.trackNumber": "Track no.",
    "tags.discNumber": "Disc no.",
    ...
    "tags.trackTitleRequired": "Track title is required.",
    "tags.trackSaved": "Saved track tags.",
    "tags.editSelected": "Edit selected album tags",
    "trackDetail.label": "Track details",
    "trackDetail.close": "Close track details",
    "trackDetail.infoTab": "Info",
    "trackDetail.lyricsTab": "Lyrics",
    "trackDetail.emptyTag": "Click to set",
    "trackDetail.duration": "Duration",
    "trackDetail.filePath": "File path",
    "trackDetail.noFilePath": "No file path",
    "trackDetail.noLyrics": "No lyrics are saved in this track.",
    ...
    "status.trackNotFound": "Track {trackId} was not found.",
    "status.emptyTrackTitle": "Track title is required.",
  ...
  ja: {
    ...
    "search.lyricsFilter": "歌詞があるアルバムだけ表示",
    "view.label": "アルバム表示",
    "view.largeIcons": "大アイコン",
    "view.smallIcons": "小アイコン",
    "view.list": "アルバム名リスト",
    "listMode.albums": "アルバム",
    "listMode.tracks": "曲",
    "listMode.albumTable": "アルバム表",
    "listMode.trackTable": "曲表",
    "listMode.trackCount": "曲数",
    ...
    "tags.year": "年",
    "tags.genre": "ジャンル",
    "tags.trackNumber": "トラック番号",
    "tags.discNumber": "ディスク番号",
    ...
    "tags.trackTitleRequired": "曲名は必須です。",
    "tags.trackSaved": "曲タグを保存しました。",
    "tags.editSelected": "選択中アルバムのタグを編集",
    "trackDetail.label": "曲詳細",
    "trackDetail.close": "曲詳細を閉じる",
    "trackDetail.infoTab": "曲情報",
    "trackDetail.lyricsTab": "歌詞",
    "trackDetail.emptyTag": "クリックして設定",
    "trackDetail.duration": "長さ",
    "trackDetail.filePath": "ファイルパス",
    "trackDetail.noFilePath": "ファイルパスなし",
    "trackDetail.noLyrics": "この曲に保存された歌詞はありません。",
    ...
    "status.trackNotFound": "曲 {trackId} が見つかりません。",
    "status.emptyTrackTitle": "曲名は必須です。",
