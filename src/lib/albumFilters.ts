...
export function filterAndSortAlbums(albums: Album[], query: string, sortMode: AlbumSortMode, t: TFunction, lyricsOnly = false) {
  return new AlbumCollection(albums, t).filterAndSort(query, sortMode, lyricsOnly);
}
