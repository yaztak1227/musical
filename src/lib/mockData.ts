    ...
    tracks: [
      {
        ...
        hasLyrics: true,
        lyrics: [
          "Station lights are passing slow",
          "A signal hums below",
          "We wait between the rails",
          "Until the city glows",
          "Footsteps fold into the rain",
          "The platform breathes again",
          "A silver line begins to bend",
          "Around the midnight end",
          "Every window catches fire",
          "Every wire sings higher",
          "Hold the ticket in your hand",
          "Let the dark announce the band",
          "Station lights are passing slow",
          "A signal hums below",
          "We keep the rhythm in our coats",
          "And send it down the tracks",
          "Blue signs drift above the crowd",
          "The wheels become a cloud",
          "Somewhere past the river wall",
          "The first bright towers call",
          "If the morning finds us there",
          "With static in our hair",
          "We'll remember how it felt",
          "To move before we knew",
        ].join("\n"),
      },
