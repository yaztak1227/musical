...
- Fire TV 版でテレビ向けの再生、キュー、歌詞画面を表示
- ちびキャラ、ちびキャラオーケストラのビジュアライザ表示
...
ビジュアライザは、音に合わせて動くちびキャラ表示にも切り替えられます。通常のちびキャラに加えて、ちびキャラオーケストラ表示も用意しています。

![ちびキャラビジュアライザ](docs/images/musical-chibi-visualizer.png)

## Fire TV 版

Musical には Fire TV 向けの companion app があり、テレビに合わせた再生画面、キュー、歌詞、アルバム、曲一覧を表示できます。同じ LAN 上のデスクトップサーバーを検出して接続でき、開発時はエミュレータから URL を指定して確認できます。

![Musical Fire TV のプレイヤー画面](docs/images/musical-firetv-player.png)
