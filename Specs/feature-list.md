...
- 一覧ツールバーは表示種別に追従し、アルバム表示ではタイトル・アーティスト・年、プレイリスト表示ではプレイリスト名・曲数を独立した昇順・降順で並び替える。歌詞フィルターはアルバム表示では歌詞付きアルバム、プレイリスト表示では歌詞付き曲を含むプレイリストへ適用する。
...
- 下部プレイヤーは再生元をアルバム/プレイリストの型で判別し、対応するアートワークまたはアイコン、名称、詳細パネルへの導線を表示する。
